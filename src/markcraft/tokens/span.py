...
from markcraft.parser import span_tokenizer as tokenizer
from markcraft.tokens import base as token
from markcraft.tokens import core as core_tokens
...
def tokenize_inner(content):
    ...
    """
    return tokenizer.tokenize(content, get_token_types())
