...
from markcraft import render
import markcraft.renderers.latex
...
class TestLaTeXRenderer(TestCase):
    ...
    def test_inline_code(self):
        func_path = 'markcraft.renderers.latex.LaTeXRenderer.render_raw_text'
        ...
        content = markcraft.renderers.latex.verb_delimiters
    ...
    def test_table_with_header(self):
        func_path = 'markcraft.renderers.latex.LaTeXRenderer.render_table_row'
...
class TestHtmlEntity(TestCase):
    def test_html_entity(self):
        self.assertIn('hello \\& goodbye', render('hello &amp; goodbye', LaTeXRenderer))

    def test_html_entity_in_link_target(self):
        self.assertIn('\\href{foo}{hello}', render('[hello](f&#111;&#111;)', LaTeXRenderer))
