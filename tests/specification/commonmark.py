...
import sys
import json
from markcraft import Document, HtmlRenderer
...
KNOWN = []
"""
Examples (their numbers) from the specification which are known to fail in markcraft.
"""
...
def load_tests(specfile):
    ...
    for test in tests:
        ...
        # So we unescape square brackets in URLs to match markcraft's behavior.
...
def main():
    ...
    parser.add_argument('-f', '--file', dest='tests', type=load_tests,
                        default='tests/specification/commonmark.json',
