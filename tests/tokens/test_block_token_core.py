...
class TestToken(unittest.TestCase):
    def setUp(self):
        ...
        patcher = patch('markcraft.tokens.span.RawText')
...
class TestQuote(unittest.TestCase):
    def test_match(self):
        with patch('markcraft.tokens.block.Paragraph'):
...
class TestTable(unittest.TestCase):
    ...
    def test_match(self, delimiter_line):
        ...
        with patch('markcraft.tokens.block.TableRow') as mock:
            token, = block_token.tokenize(lines)
...
class TestTableRow(unittest.TestCase):
    def test_match(self):
        with patch('markcraft.tokens.block.TableCell') as mock:
            line = '| cell 1 | cell 2 |\n'
